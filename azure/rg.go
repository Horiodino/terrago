...
func init() {
	// &rg_name is the variable that will hold the value of the flag
	// "rgname" is the name of the flag used as --rgname
...
func main() {
	rootCmd := &cobra.Command{Use: "rgname"}
